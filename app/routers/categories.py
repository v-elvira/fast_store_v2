...
async def create_category(category: CategoryCreate, db: Session = Depends(get_db)):
    ...
    db_category = CategoryModel(**category.model_dump())   # sqlite 3.31 has no 'returning' for efficient 'insert':
...
#     import sqlite3
#
#     print("SQLite Version is:", sqlite3.sqlite_version)  # SQLite Version is: 3.31.1
#     print("DB-API Version is:", sqlite3.version)         # DB - API Version is: 2.6.0
#     # sqlite3.OperationalError: near "RETURNING": syntax error
#     # Support for the RETURNING clause was added to SQLite starting from version 3.35.0
